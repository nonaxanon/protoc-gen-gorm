...
or `go get github.com/nonaxanon/protoc-gen-gorm`.
...
- Barebones C/U/R/D/L handlers that accept the protobuf versions (as from
  ...
  operators https://github.com/nonaxanon/atlas-app-toolkit#collection-operators),
...
in the [atlas-app-toolkit](https://github.com/nonaxanon/atlas-app-toolkit#middlewares)
